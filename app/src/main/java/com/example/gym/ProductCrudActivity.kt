...
class ProductCrudActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Integrasi Navigasi Bawah Segiempat
        ...
        // TRIGGER MODAL: Klik tombol FAB bulat merah untuk tambah data baru
    ...
    private fun loadProductsData(searchKeyword: String) {
        val request = object : StringRequest(Method.POST, urlWebService,
            { response ->
                try {
                    ...
                    for (i in 0 until jsonArray.length()) {
                        ...
                        val row = LayoutInflater.from(this).inflate(R.layout.item_product_row, binding.containerProducts, false)
            ...
            { Toast.makeText(this, "Koneksi server gagal", Toast.LENGTH_SHORT).show() }
        ) {
    ...
    private fun showProductModal(productObject: JSONObject?) {
        ...
        btnSave.setOnClickListener {
            ...
            val request = object : StringRequest(Method.POST, urlWebService,
                ...
                { Toast.makeText(this, "Gagal memproses ke server", Toast.LENGTH_SHORT).show() }
            ) {
